...
pub async fn system(_r: RateLimit<'_>, _auth: API, sys: &State<System>) -> Value {
    json!({
...
pub async fn rust(_r: RateLimit<'_>, _auth: API) -> Value {
    json!({
...
pub async fn package(_r: RateLimit<'_>, _auth: API) -> Value {
    json!({
...
pub async fn git(_r: RateLimit<'_>, _auth: API) -> Value {
    json!({
