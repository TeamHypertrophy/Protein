...
pub async fn get(user_id: Uuid, workout_id: Uuid) -> String {
...
pub async fn update(user_id: Uuid, workout_id: Uuid) -> String {
...
pub async fn delete(user_id: Uuid, workout_id: Uuid) -> String {
